...
- ✅ Changed User ID from Integer to CUID (Collision-resistant Unique ID)
- ✅ Added password hashing with bcrypt (salt rounds: 10)
- ✅ Added `createdAt` and `updatedAt` timestamps to User model
- ✅ Secured API responses: password field excluded from responses
- ✅ Updated all endpoints to use CUID instead of numeric ID
